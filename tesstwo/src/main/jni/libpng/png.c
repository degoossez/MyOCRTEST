 ...
 */
png_voidp PNGAPI
png_get_io_ptr(png_const_structrp
png_ptr)
{
if (png_ptr == NULL)
return (NULL);
...
png_const_charp PNGAPI
png_get_copyright(png_const_structrp
png_ptr)
{
 ...
 */
png_const_charp PNGAPI
png_get_libpng_ver(png_const_structrp
png_ptr)
{
...
png_const_charp PNGAPI
png_get_header_ver(png_const_structrp
png_ptr)
{
...
png_const_charp PNGAPI
png_get_header_version(png_const_structrp
png_ptr)
{
