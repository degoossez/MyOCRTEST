...
0, "Exposure level in photocopier");
...
0, "Padding around produced bounding boxes");
...
"Arial", "Font description name to use");
...
false, "List available fonts and quit.");

BOOL_PARAM_FLAG(render_ngrams,
false, "Put each space-separated entity from the"
